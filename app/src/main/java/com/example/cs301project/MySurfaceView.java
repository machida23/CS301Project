...
public class MySurfaceView extends SurfaceView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawBitmap(whiteKnight,w-w*7/8,0.f,null);
        canvas.drawBitmap(whiteKnight, w-w*2/8,0.f,null);

        canvas.drawBitmap(whiteKnight, w-w*7/8, w-w*1/8, black);
        canvas.drawBitmap(whiteKnight, w-w*2/8,w-w*1/8,black);
